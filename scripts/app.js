...
const render = () => {
  ...
  console.log("current lives" + livesLeft);
...
if (livesLeft1 <= 1){
document.getElementById("livesReduction").disabled = true;
console.log("lives less than 1 or is 1")
}else{
console.log("lives more than 1")
}
...
function calculateStats() {
  ...
  console.log("--> ", guessedLetters.length, figureGuessWordsLength);
  if (guessedLetters.length == figureGuessWordsLength) {
    console.log("matched");
    console.log(LSdataWordle.CurrrentStreak);
    ...
    console.log(LSdataWordle.WinPercentage);
  ...
  console.log(LSdataWordle.DaysPlayed);
  console.log(LSdataWordle);
}
function calculateEmoji() {
  console.log("puzzle DIV", puzzleDIV);
...
$("#share-button").on("click", function () {
  ...
  console.log(`${totalGuessed}/${guessedScoreArray.length}`);
...
/*$(document).on('click','#twords span',function(){
var word=$(this).html()
$.ajax({
